  ...
  networking = {
    interfaces.enp0s8 = {
      ...
      ipv4.routes = [
        ...
        { address = "192.168.2.0"; prefixLength = 24; via = "192.168.3.2"; }
        { address = "192.168.4.0"; prefixLength = 24; via = "192.168.4.4"; }
        { address = "192.168.5.0"; prefixLength = 24; via = "192.168.5.5"; }
        { address = "192.168.6.0"; prefixLength = 24; via = "192.168.6.6"; }
        { address = "192.168.7.0"; prefixLength = 24; via = "192.168.7.7"; }
        { address = "192.168.8.0"; prefixLength = 24; via = "192.168.8.8"; }
        { address = "192.168.9.0"; prefixLength = 24; via = "192.168.9.8"; }
        { address = "192.168.10.0"; prefixLength = 24; via = "192.168.10.9"; }
      ];
    };
