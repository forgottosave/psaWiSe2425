  ...
  networking = {
    interfaces.enp0s8 = {
      ipv4.addresses = [
        ...
        { address = "192.168.31.%%vm%%"; prefixLength = 24; }
        { address = "192.168.32.%%vm%%"; prefixLength = 24; }
        { address = "192.168.43.%%vm%%"; prefixLength = 24; }
        { address = "192.168.53.%%vm%%"; prefixLength = 24; }
        { address = "192.168.63.%%vm%%"; prefixLength = 24; }
        { address = "192.168.73.%%vm%%"; prefixLength = 24; }
        { address = "192.168.83.%%vm%%"; prefixLength = 24; }
        { address = "192.168.93.%%vm%%"; prefixLength = 24; }
        { address = "192.168.103.%%vm%%"; prefixLength = 24; }
      ];
      ipv4.routes = [
